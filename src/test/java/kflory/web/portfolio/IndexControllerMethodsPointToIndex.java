...
public class IndexControllerMethodsPointToIndex {
	...
	@Test
	public void testGetReturnsDefaultMessage() throws Exception {
		assertThat(
			this.restTemplate.getForObject(
				"http://localhost:" + port + "/",
				String.class))
	...
	@Test
	public void testPostReturnsDefaultMessage() throws Exception {
		assertThat(
			this.restTemplate.postForObject(
				"http://localhost:" + port + "/",
				new String("Fail! This string will be in the request body."),
				String.class))
			.contains("failsnail");
	}
}
